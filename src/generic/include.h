#ifndef mulle_objc_regex_foundation_include_h__
#define mulle_objc_regex_foundation_include_h__

// this is a global symbol that is exposed, which can be used to detect
// if this library is available

#define HAVE_INCLUDE_MULLE_OBJC_REGEX_FOUNDATION
...
#include "_MulleObjCRegexFoundation-include.h"

#ifndef MULLE_OBJC_REGEX_FOUNDATION_GLOBAL
# ifdef MULLE_OBJC_REGEX_FOUNDATION_BUILD
#  define MULLE_OBJC_REGEX_FOUNDATION_GLOBAL    MULLE_C_GLOBAL
# else
#  if defined( MULLE_OBJC_REGEX_FOUNDATION_INCLUDE_DYNAMIC) || (defined( MULLE_INCLUDE_DYNAMIC) && ! defined( MULLE_OBJC_REGEX_FOUNDATION_INCLUDE_STATIC))
#   define MULLE_OBJC_REGEX_FOUNDATION_GLOBAL   MULLE_C_GLOBAL
#  else
#   define MULLE_OBJC_REGEX_FOUNDATION_GLOBAL   extern
#  endif
# endif
#endif
