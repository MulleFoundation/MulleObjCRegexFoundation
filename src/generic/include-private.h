#ifndef mulle_objc_regex_foundation_include_private_h__
#define mulle_objc_regex_foundation_include_private_h__
 ...
 */
#include "_MulleObjCRegexFoundation-include-private.h"
